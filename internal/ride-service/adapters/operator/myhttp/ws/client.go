...
func NewClient(ctx context.Context, log logger.Logger, conn *websocket.Conn, dis *Dispatcher, passengerId string, cancelAuth context.CancelFunc, wg *sync.WaitGroup) *Client {
	return &Client{
		log:         log,
		ctx:         ctx,
		conn:        conn,
